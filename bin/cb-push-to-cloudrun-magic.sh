...
# copied from ~/git/gemini-news-crawler/webapp/bin/
# Alternatives:
#-rwxr-xr-x  1 ricc  primarygroup  4599 Apr 16 19:51 dhh-vanilla-701/bin/cb-push-to-cloudrun.sh
#-rwxr-xr-x  1 ricc  primarygroup  5562 Jan 28  2024 ror7-tailwind-puffintours/bin/cb-push-to-cloudrun.sh
