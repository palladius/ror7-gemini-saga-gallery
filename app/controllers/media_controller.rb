class MediaController < ApplicationController
  ...
  private
    ...
    def medium_params
      params.require(:medium).permit(:title, :path, :caption, :media_type, :gallery_id, :gemini_relevance, :gemini_quality, :gemini_description, :gemini_text, :file_size, :dimensions, :original_filename, :user_id)
    end
end
